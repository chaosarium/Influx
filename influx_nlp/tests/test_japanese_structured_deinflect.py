                    ...
                    segments=[
                        SentSegV2(
                            ...
                            attributes=SegAttribute(
                                ...
                                dependency=(0, 'ROOT'),
                                misc={
                                    'Inflection': '助動詞-レル;終止形-一般',
                                    'Reading': 'コロサレルナ',
                                    'furigana_bracket': '殺[ころ]されるな',
                                    'furigana_ruby': '<ruby>殺<rt>ころ</rt></ruby>されるな',
                                    'furigana_parentheses': '殺(ころ)されるな',
                                    'hiragana_reading': 'ころされるな',
                                    'conjugation_base': '殺す',
                        ...
                        SentSegV2(
                            ...
                            attributes=SegAttribute(
                                ...
                                misc={
                                    ...
                                    'Reading': 'イッタ',
                                    'furigana_bracket': 'いった',
                                    'furigana_ruby': 'いった',
                                    'furigana_parentheses': 'いった',
