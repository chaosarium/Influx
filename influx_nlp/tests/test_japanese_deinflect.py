...
def test_grammar_rules():
    ...
    # assert get_deinflected('殺されるな') == snapshot(('殺す', [WordType.PASSIVE, WordType.NA_PARTICLE])) # commented out in js version for some reason
    ...
    # assert get_deinflected('いろ') == snapshot(('いる', [WordType.IMPERATIVE])) # commented out in js version for some reason
    ...
    # assert get_deinflected('書かれてなかった') == snapshot(('書く', [WordType.PASSIVE, WordType.TE_FORM, WordType.ARU, WordType.NEGATIVE_NAI_VERB, WordType.PLAIN_PAST])) # commented out in js version for some reason
