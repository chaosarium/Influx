...
type SentenceConstituent
    = MultiwordToken { sentenceId : Int, ids : List (Int), text : String, orthography : String, startChar : Int, endChar : Int, shadowed : Bool, shadows : List (SentenceConstituent) }
...
sentenceConstituentEncoder enum =
    case enum of
        MultiwordToken { sentenceId, ids, text, orthography, startChar, endChar, shadowed, shadows } ->
            Json.Encode.object [ ( "MultiwordToken", Json.Encode.object [ ( "sentence_id", (Json.Encode.int) sentenceId ), ( "ids", (Json.Encode.list (Json.Encode.int)) ids ), ( "text", (Json.Encode.string) text ), ( "orthography", (Json.Encode.string) orthography ), ( "start_char", (Json.Encode.int) startChar ), ( "end_char", (Json.Encode.int) endChar ), ( "shadowed", (Json.Encode.bool) shadowed ), ( "shadows", (Json.Encode.list (sentenceConstituentEncoder)) shadows ) ] ) ]
...
sentenceConstituentDecoder = 
        let
            elmRsConstructMultiwordToken sentenceId ids text orthography startChar endChar shadowed shadows =
                        MultiwordToken { sentenceId = sentenceId, ids = ids, text = text, orthography = orthography, startChar = startChar, endChar = endChar, shadowed = shadowed, shadows = shadows }
