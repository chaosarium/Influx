...
documentConstituentEncoder enum =
    case enum of
        Sentence { id, text, startChar, endChar, constituents } ->
            Json.Encode.object [ ( "type", Json.Encode.string "Sentence" ), ( "id", (Json.Encode.int) id ), ( "text", (Json.Encode.string) text ), ( "start_char", (Json.Encode.int) startChar ), ( "end_char", (Json.Encode.int) endChar ), ( "constituents", (Json.Encode.list (sentenceConstituentEncoder)) constituents ) ]
        DocumentWhitespace { text, startChar, endChar } ->
            Json.Encode.object [ ( "type", Json.Encode.string "DocumentWhitespace" ), ( "text", (Json.Encode.string) text ), ( "start_char", (Json.Encode.int) startChar ), ( "end_char", (Json.Encode.int) endChar ) ]
...
sentenceConstituentEncoder enum =
    case enum of
        CompositToken { sentenceId, ids, text, orthography, startChar, endChar, shadowed, shadows } ->
            Json.Encode.object [ ( "type", Json.Encode.string "CompositToken" ), ( "sentence_id", (Json.Encode.int) sentenceId ), ( "ids", (Json.Encode.list (Json.Encode.int)) ids ), ( "text", (Json.Encode.string) text ), ( "orthography", (Json.Encode.string) orthography ), ( "start_char", (Json.Encode.int) startChar ), ( "end_char", (Json.Encode.int) endChar ), ( "shadowed", (Json.Encode.bool) shadowed ), ( "shadows", (Json.Encode.list (sentenceConstituentEncoder)) shadows ) ]
        SubwordToken { sentenceId, id, text, orthography, lemma, shadowed, shadows } ->
            Json.Encode.object [ ( "type", Json.Encode.string "SubwordToken" ), ( "sentence_id", (Json.Encode.int) sentenceId ), ( "id", (Json.Encode.int) id ), ( "text", (Json.Encode.string) text ), ( "orthography", (Json.Encode.string) orthography ), ( "lemma", (Json.Encode.string) lemma ), ( "shadowed", (Json.Encode.bool) shadowed ), ( "shadows", (Json.Encode.list (sentenceConstituentEncoder)) shadows ) ]
        SingleToken { sentenceId, id, text, orthography, lemma, startChar, endChar, shadowed, shadows } ->
            Json.Encode.object [ ( "type", Json.Encode.string "SingleToken" ), ( "sentence_id", (Json.Encode.int) sentenceId ), ( "id", (Json.Encode.int) id ), ( "text", (Json.Encode.string) text ), ( "orthography", (Json.Encode.string) orthography ), ( "lemma", (Json.Encode.string) lemma ), ( "start_char", (Json.Encode.int) startChar ), ( "end_char", (Json.Encode.int) endChar ), ( "shadowed", (Json.Encode.bool) shadowed ), ( "shadows", (Json.Encode.list (sentenceConstituentEncoder)) shadows ) ]
        SentenceWhitespace { text, orthography, startChar, endChar, shadowed, shadows } ->
            Json.Encode.object [ ( "type", Json.Encode.string "SentenceWhitespace" ), ( "text", (Json.Encode.string) text ), ( "orthography", (Json.Encode.string) orthography ), ( "start_char", (Json.Encode.int) startChar ), ( "end_char", (Json.Encode.int) endChar ), ( "shadowed", (Json.Encode.bool) shadowed ), ( "shadows", (Json.Encode.list (sentenceConstituentEncoder)) shadows ) ]
        PhraseToken { sentenceId, text, normalisedOrthography, startChar, endChar, shadowed, shadows } ->
            Json.Encode.object [ ( "type", Json.Encode.string "PhraseToken" ), ( "sentence_id", (Json.Encode.int) sentenceId ), ( "text", (Json.Encode.string) text ), ( "normalised_orthography", (Json.Encode.string) normalisedOrthography ), ( "start_char", (Json.Encode.int) startChar ), ( "end_char", (Json.Encode.int) endChar ), ( "shadowed", (Json.Encode.bool) shadowed ), ( "shadows", (Json.Encode.list (sentenceConstituentEncoder)) shadows ) ]
